...
return [
        authenticate: 	            { helper, paramsValues, credentials -> authenticate(helper, paramsValues, credentials) },
        getRequiredParamsNames: 	{ -> getRequiredParamsNames() },
        getOptionalParamsNames: 	{ -> getOptionalParamsNames() },
        getCredentialsParamsNames: 	{ -> getCredentialsParamsNames() },
        //getLoggedInIndicator: 	{ -> getLoggedInIndicator() },
        //getLoggedOutIndicator: 	{ -> getLoggedOutIndicator() },
]